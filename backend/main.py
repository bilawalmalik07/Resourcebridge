...
# Secure Document Upload Route with Live AI Processing
...
def upload_document(
    ...
    """Securely uploads a document and automatically triggers the Gemini AI intelligence engine."""

    # Step 1: Pass the file URL to our Gemini processing pipeline
    ...
    # Step 2: Construct the new record with live data generated by the AI
    new_doc = models.Document(
        title=doc_in.title,
        file_url=doc_in.file_url,
        category=doc_in.category or "Uncategorized",
        ocr_text=ai_results["ocr_text"],       # ◄ Real text extracted by AI
        # ◄ Real summary/translation generated by AI
